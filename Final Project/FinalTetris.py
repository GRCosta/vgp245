...
class GameScreen:
    def __init__(self, master):
        ...
        self.button1 = Button(self.master,text = 'Pause', width = 25, command=self.app.toggle_pause)
        self.button1.pack()

        self.quitButton = tk.Button(self.master, text = 'Quit', width = 25, command = self.close_windows)
        self.quitButton.pack(side = BOTTOM)

        self.playButton = tk.Button(self.master, text = 'Play', width = 25, command = self.app.run)
